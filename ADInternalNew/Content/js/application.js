    ...
    $('.send-message').keypress(function (e) {
        if (e.keyCode == 13) {
            var chat_message = '<li class="img">' +
                ...
                '<img src="Content/img/avatars/avatar1.png" data-retina-src="Content/img/avatars/avatar1_2x.png"/>' +
...
var setColor = function (color) {
    ...
    $('#theme-color').attr("href", "Content/css/colors/" + color_ + ".css");
    if ($.cookie) {         
...
if($.cookie('style-color')){
    ...
    $('#theme-color').attr("href", "Content/css/colors/color-dark.css");
}
